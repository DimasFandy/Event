...
<div class="container">
    ...
    <div class="card shadow-lg p-4 rounded">
        <form action="{{ route('roles.store') }}" method="POST" style="max-height: 500px; overflow-y: auto; padding-bottom: 50px;">
            @csrf
        ...
        <div class="d-flex justify-content-center" style="position: sticky; bottom: 0; background-color: white; z-index: 1; padding-top: 10px;">
