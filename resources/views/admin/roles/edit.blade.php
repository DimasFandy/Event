...
<div class="container">
    ...
    <div class="card shadow-lg p-4 rounded">
        <form action="{{ route('roles.update', $role->id) }}" method="POST" style="max-height: 500px; overflow-y: auto; padding-bottom: 50px;">
            @csrf
            @method('PUT')
        ...
        <div class="d-flex justify-content-between mt-3" style="position: sticky; bottom: 0; background-color: white; z-index: 1;">
